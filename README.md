...
- 😄 Technical use: 
1. Programing languages: HTML, CSS, SASS, vanilla javascript, TypeScript, Python, SQL, PHP (out of practice).
2. Library or framework: React (Hooks, Context, Router, React-Redux), Redux, Bootstrap5
