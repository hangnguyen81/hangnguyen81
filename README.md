...
- 😄 Technical use: 
- Programing languages: HTML, CSS, SASS, vanilla javascript, TypeScript, Python, SQL, PHP (out of practice).
- Library or framework: React (Hooks, Context, Router, React-Redux), Redux, Bootstrap5
